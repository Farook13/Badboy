...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await m.delete()
        m=await message.reply_sticker("CAACAgIAAxkBAAIdrmZkF-swKfxRSHtk6B7uV-IY4jN1AAKSAQACVp29Cp_QLQhCLtUFNAQ")
        await asyncio.sleep(0.7)
        await m.delete()
        m=await message.reply_sticker("CAACAgIAAxkBAAIdsGZkF_q7E85eXGnBAAElFbUYL_ZG_gAC5gEAAhZCawpGz_DN2k8g4TQE")
        await asyncio.sleep(0.5)
        await m.edit_text("<b><i>ꜱᴛᴀʀᴛɪɴɢ...</i></b>")
        await asyncio.sleep(0.7)
        await m.delete()        
        m=await message.reply_sticker("CAACAgIAAxkBAAIdsmZkF_w4EynY7TYAAYR8lMyPkGgr-gAC2wEAAhZCawpB6I9URyVwQDQE") 

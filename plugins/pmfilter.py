...
async def give_filter(client, message):
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/movie_hubby")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+JeWFhkIdXkdiNzc1")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/movie_hubby")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ʀᴇq ᴍᴏᴠɪᴇꜱ⚡', url='https://t.me/movie_hubby'),
            InlineKeyboardButton('✨️ᴏᴛᴛ ᴍᴏᴠɪᴇꜱ✨️', url='https://t.me/+JeWFhkIdXkdiNzc1')
        ],[
            InlineKeyboardButton('🎬 𝐌𝐨𝐯𝐢𝐞𝐬 ʀᴇq 🎬', url='https://t.me/+JeWFhkIdXkdiNzc1')
        ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'Seaching for {search} 🔎', url=f"https://t.me/movie_hubby")]]) 
            )
            search = search.lower()
            find = search.split(" ")
            search = ""

...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await m.delete()
        m=await message.reply_sticker("CAACAgEAAxkBAAIY9GYb_ZTAlHkVXIp59QMq4xrwwdwEAAJUAgACODjZR-6jaMt58aQENAQ")
        await asyncio.sleep(0.7)
        await m.delete()
        m=await message.reply_sticker("CAACAgEAAxkBAAIY9mYb_ZjiG3EIjST1Zm3HkNqZSympAAJVAwACYsnYR1h_1CjSvNmbNAQ")
        await asyncio.sleep(0.5)
        await m.edit_text("<b><i>ꜱᴛᴀʀᴛɪɴɢ...</i></b>")
        await asyncio.sleep(0.7)
        await m.delete()        
        m=await message.reply_sticker("CAACAgEAAxkBAAIY6GYb_WeMkPGtjZIWxjwx1-qTxVsFAAIKBAACtXPZR7qAgjnBR-YMNAQ") 
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        await asyncio.sleep(0.7)
        await m.delete()        
        m=await message.reply_sticker("CAACAgEAAxkBAAIY4mYb_Tx9mVqEG_SC_sebkjrN1_QxAALRAgAC3sXYRzU-aLmaObA3NAQ") 
        await asyncio.sleep(1)
        await m.delete()
        await message.reply_photo(
            photo=random.choice(PICS),
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/+JeWFhkIdXkdiNzc1') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/+JeWFhkIdXkdiNzc1</code></b>")
